...
I received the completed lidar scans from Merl about 12 minutes ago. Yep, that cenote is indeed IDH, Inconveniently Deep Hole. We have satellite imagery of the Hole back to the early 2000s with ten meter resolution, and better than that for some years since. As far as I know, you’re the first ever to scan the entire surface at close range using LIDAR.

The Pool of Xblanque, as you say that locals now call it, occurs on survey maps back to the 1920s, just tagged by an elevation contour: the interior has no detail indicated at all. “Here be dragons.” Since it's a 60 meter rappel from the edge to the bottom, it's little wonder that it was never mapped by hand survey. 

The name 'Inconveniently Deep Hole' crops up in cave literature around the same time, in lists of cenotes in the Yucatan. The thing about the name “Inconveniently Deep Hole” being a translation from Mayan is a myth, by the way, perhaps an invention of yellow journalism later taken as fact. No one knows what the feature was called by ancient people in the area. 
